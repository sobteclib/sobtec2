...
alle troep het meer in, dat daardoor zwaar vervuild raakte en begon te stinken. 
Strenge wetten werden aangenomen, maar ondanks 
waarschuwingen en boetes gebeurde er niets; zelfs gevangenisstraffen hielpen niet. De 
...
En toen verscheen er op een dag een manager in de stad. Hij stelde voor om te helpen het probleem op te lossen, maar alleen als het stadsbestuur 
...
NB: 'delegation' is een kernwoord in Ippolita's theorie: het geeft aan - en veroordeelt - dat je aan een andere instantie/persoon 'delegeert' wat jij zelf zou moeten doen.
...
privieges; spelers die uitblonken konden in rang stijgen en zodoende 
...
Het stadsbestuur werd opgeheven. In zijn plaats kwam er een 'technisch 
...
Het moge vanzelfsprekend zijn dat wij straf niet verdedigen, noch repressieve systemen prijzen. Verbod 
...
omgekeerde van de vorige aanpak. Zowel straf als beloning verloochenen 
...
Echte opvoeding heeft niets te maken met het naleven van opgelegde 
...
De kloof tussen leren en trainen is smal. Het ligt eigenlijk maar net aan het 
molecuul dat een sleutelrol speelt bij leren als reactie op een 
...
toename in concentratie van deze neurotransmiter overeen komt. Hetzelfde 
...
motorische programma's geactiveerd die genotsgevoelens dan wel mechanismen die pijn 
trachten te vermijden in gang zetten. De uitwerking van verslavende 
substancies vindt plaats in hetzelfde gedeelte van het brein, en 
activeren gevoelens van genot. De neuronale connecties die op die manier 
ontstaan worden allengs versterkt, en boeten daarbij in aan
...
En dat is dan ook de reden waarom training zo effectief is: het is 
verslavend! Het plezier dat uit het automatisme voort komt, ook bekend als 
dwangmatig handelen, stort ons in een vicieuze cirkel waar het in 
...
die al deel uitmaken van ons onbewuste geheugen. De cognitieve inspanning en berekening hiervan is minimaal, omdat wij helemaal niet hoeven na te denken over wat wij doen. We handelen automatisch. Redeneren vergt daarentegen een substantiële 
...
hetgeen een langzaam tempo en volledige inzet vergt. Intuïtie stelt 
...
procedureel geheugen is automatisch betrokken bij alle handelingen die 
...
die het meest geschikt lijkt om de taak succesvol 
...
dan de binnenband uit het wiel te peuteren en die te plakken, en als het niet lukt 
kunnen we om hulp vragen, of het op een andere manier proberen aan te 
aanpakken, met andere woorden, een nieuwe procedure creëren ...

Over het algemeen leidt regelmatig gebruik van een digitaal medium, zoals een web 
interface, tot het aanleren van gebruik op de automatische piloot. Als deze interfaces op een dusdanige manier zijn ontworpen dat ze op de meest inuïtieve en eenvoudige 
...
te kijken.
Eenmaal getraind, is de geest in staat om een voorafgaande interne simulatie te creëren van de actie die wij gaan uitvoeren: 
het intuïtief vermogen is dus het vermogen om een bekende procedure te 
simuleren en die geheel automatisch ten uitvoer te brengen. De 
automatisering valt samen met de uitvoering van de procedure. Hieruit vloeit een van de duidelijkste misvattingen voort over de vermeende voordelen van het gebruik van digitale apparaten in onze leerprocessen en ook over een vermeend 
...
met een functionerend brein kunnen 'digital natives' worden, omdat het 
...
met zich mee, die verslavend is en leidt tot het selectief negeren van niet-visuele stimuli. En als je afstand neemt van het scherm na een sessie die 
...
Voor miljoenen mensen zijn videogames (spelletjes) een essentieel 
...
angstgevoelens onderdrukt en een positief sociaal gedrag versterkt, 
...
bij mensen, door het geven van beloningen op een niet-automatische wijze. De rat drukt op een knopje en krijgt dan voedsel 
aangereikt - maar niet altijd. De training werkt beter, dat wil zeggen, 
de knopjes worden vaker ingedrukt, als de positieve tegemoetkoming niet 
...
grootste fopperij van game-ificatie, en het wordt toegepast in 
videogames alsmede in allerlei andere vormen van spelletjes.

Interactie met digitale media bestaat niet per se louter uit zelf-training, 
oefenen van het procedureel geheugen, synchroon vernuft of intuïtie. 
...
geest van vermoeidheid afknappen, is een voorbeeld van wangebruik dat de 
...
het waarnemen van je interpersoonlijke handelingen en het luisteren naar 
je persoonlijke neigingen. Het doel hiervan is om zelf te bepalen welk tempo het best 
...
## Van zelfverdediging naar pedagogische hacker convivialiteit
...
onderdeeltjes van de 'Corporate Megamachine' reduceren. Voor ons 
...
naar boven - en het is cruciaal om deze binnen de beschermde sfeer van de groep te houden, ver van de 
...
gekozen hebben en die ons geen beter gevoel geven.

De tweede 
stap bestaat in het observeren van ons gedrag, alsof wij 
vreemden waren met vreemde gewoontes - rare dieren die geïrriteerd 
...
automatismen (in de vorm van prikkel - reactie, oftewel 
...
persoonlijke interactieve liturgie opvrolijken op te brengen in aparte 
